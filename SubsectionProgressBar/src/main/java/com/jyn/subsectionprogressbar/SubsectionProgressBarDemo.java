...
public class SubsectionProgressBarDemo extends View {
    ...
    public SubsectionProgressBarDemo(Context context) {
        super(context);
        init();
    }

    public SubsectionProgressBarDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SubsectionProgressBarDemo(Context context, AttributeSet attrs, int defStyleAttr) {
